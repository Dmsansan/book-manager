...
},beforePageText:"跳转至",afterPageText:"在 {pages}页中",displayMsg:"当前展示 {from} 到 {to} 总共 {total} 记录数",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"必填项！",invalidMessage:null,tipPosition:"right",deltaX:0,deltaY:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_4be,blur:_4c2,mouseenter:_4c5,mouseleave:_4c8,click:function(e){
var t=$(e.data.target);
...
},message:"请输入正确的邮箱地址."},url:{validator:function(_4ed){
...
},message:"输入正确的URL地址."},length:{validator:function(_4ee,_4ef){
var len=$.trim(_4ee).length;
return len>=_4ef[0]&&len<=_4ef[1];
},message:"输入的字符串数量需在 {0} 和 {1}之间."},remote:{validator:function(_4f0,_4f1){
var data={};
data[_4f1[1]]=_4f0;
var _4f2=$.ajax({url:_4f1[0],dataType:"json",data:data,async:false,cache:false,type:"post"}).responseText;
return _4f2=="true";
},message:"请输入信息."}},onBeforeValidate:function(){
...
_b94(this,q);
}},currentText:"Today",closeText:"关闭",okText:"确认",buttons:[{text:function(_ba9){
